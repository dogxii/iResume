...
import type { ResumeDocument, ResumeLibrary } from '../data/resumeLibrary'
import {
  ...
  switch (action.type) {
    ...
    case 'undo': {
      ...
      return {
        ...
        future: [state.workspace.library, ...state.future].slice(
          0,
          MAX_UNDO_STEPS
        ),
        lastChange: null,
...
export function useResumeWorkspace(repository?: ResumeWorkspaceRepository) {
