...
interface ResumeManagerProps {
  ...
  onCreateFromJson: (input: CreateResumeFromJsonInput) => Promise<string | null>
    ...
    >
      ...
      >
        <ResumePreview
          ...
          sectionTitleFontSizePx={document.appearance.sectionTitleFontSizePx}
...
const TemplateAccentColorPicker = ({
  ...
  return (
    <fieldset
      ...
      title='模板主题色'
    >
      <legend className='sr-only'>模板主题色</legend>
      ...
      <div className='flex items-center gap-1.5'>
        ...
        <label
          ...
          style={
            isPresetColor ? undefined : { backgroundColor: normalizedValue }
          }
          title='自定义主题色'
          aria-label='自定义主题色'
        >
